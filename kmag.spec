...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kmag-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kmag-24.05.0.tar.xz.sig
...
%setup -q -n kmag-24.05.0
cd %{_builddir}/kmag-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716523698
mkdir -p clr-build
pushd clr-build
