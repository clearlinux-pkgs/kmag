...
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kmag-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kmag-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kmag-23.04.1
cd %{_builddir}/kmag-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685586463
mkdir -p clr-build
pushd clr-build
