...
Version  : 18.08.0
Release  : 1
URL      : https://download.kde.org/stable/applications/18.08.0/src/kmag-18.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/18.08.0/src/kmag-18.08.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GFDL-1.2 GPL-2.0
Requires: kmag-bin
Requires: kmag-data
Requires: kmag-license
Requires: kmag-locales
Requires: kmag-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1535199076
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535199076
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kmag
cp COPYING %{buildroot}/usr/share/doc/kmag/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/kmag/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang kmag
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kmag/COPYING
/usr/share/doc/kmag/COPYING.DOC
