...
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kmag-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kmag-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kmag-23.08.3
cd %{_builddir}/kmag-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701996237
mkdir -p clr-build
pushd clr-build
