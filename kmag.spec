...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kmag-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kmag-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kmag-19.12.1
cd %{_builddir}/kmag-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578619592
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmag-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kmag/b1c25bcf0e44653a0ab61b5e3a5b2841414d0033
cp %{_builddir}/kmag-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmag/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang kmag
